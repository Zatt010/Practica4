  ...
  Background:
    ...
    Scenario Outline: Filling billing information correctly
        ...
        Examples:
            ...
            | Bob Brown  | 789 Pine Rd     | Sometown  | TX    | 11223 | 555-987-9876  |                  | American Express  | 340033344455500  | 10/97      |
            | J0hn Doe   | 123 Elm St      | Anytown    | NY    | 12345 | 555-123-1234  | john@example.com | Visa              | 4111222233334444  | 12/95      |  
            | Jane Smith | 456 Oak Av3     | Othertown  | CA    | 67890 | 555-567-5678  | jane@example.com | MasterCard        | 5500111122223333  | 11/96      |  
            | Bob Brown  | 789 Pine Rd     | Some1town  | TX    | 11223 | 555-987-9876  | bob@example.com  | American Express  | 340022233344400   | 10/97      |  
            | John Doe   | 123 Elm St      | Anytown    | NY1   | 12345 | 555-123-1234  | john@example.com | Visa              | 4111333344445555  | 12/95      |  
    ...
    Scenario Outline: Filling billing information with an empty field
        ...
        Examples:
            ...
            | Jane Smith | 456 Oak Ave     | Othertown | CA    | 67890 |               | jane@example.com | MasterCard        | 5500222333444000 | 11/96      | "Please enter a valid phone number in this field."       |
            | Jane Smith | 456 Oak Ave     | Othertown | CA    | 67890 | 555-567-5678  | jane@example.com | MasterCard        |                 | 11/96      | "Please enter a valid card number of the form '1234-1234-1234-1234' in this field." |
            | Bob Brown  | 789 Pine Rd     | Sometown  | TX    | 11223 | 555-987-9876  | bob@example.com  | American Express  | 340044455566600  |            | "Please enter a valid date of the form 'MM/YY' in this field."  |
    ...
    Scenario Outline: Filling billing information with incorrect information
        ...
        Examples:
            | Name       | Address         | City       | State | Zip    | Phone         | E-mail           | Credit Card    | Card Number   | Expiration | Alert                            |
            | Jane Smith | 456 Oak Ave     | Othertown  | CA    | 6789A | 555-567-5678  | jane@example.com | MasterCard        | 5500222333444000  | 11/96      | "Please enter a valid zip code in this field." |
            | Jane Smith | 456 Oak Ave     | Othertown  | CA    | 67890 | 555-567-5678  | jane@example.com | MasterCard        | 5500333444555A00  | 11/96      | "Please enter a valid card number of the form '1234-1234-1234-1234' in this field." |
            | Bob Brown  | 789 Pine Rd     | Sometown   | TX    | 11223 | 555-987-9876  | bob@example.com  | MasterCard        | 5500444455556666  | 13/97      | "Please enter a valid date of the form 'MM/YY' in this field." |
            | Bob Brown  | 789 Pine Rd     | Sometown   | TX    | 11223 | 555-987-98A6  | bob@example.com  | American Express  | 340033344455500   | 10/97      | "Please enter a valid phone number in this field."|
